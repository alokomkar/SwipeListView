package com.alokomkar.letsventure.letsventure.view;
...
import com.alokomkar.letsventure.letsventure.MainActivity;
...
public class FlingCardListener implements View.OnTouchListener {
    ...
    public FlingCardListener(View frame, Object itemAtPosition, float rotation_degrees, FlingListener flingListener, OnActionClickInterface onActionClickInterface) {
        super();
        ...
        this.BASE_ROTATION_DEGREES = rotation_degrees;
        this.mFlingListener = flingListener;
        this.onActionClickInterface = onActionClickInterface;
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                onActionClickInterface.performAction();
